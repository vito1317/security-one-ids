...
class LogDiscoveryServiceSecurityTest extends TestCase
{
    ...
    public function test_is_allowed_path()
    {
        ...
        $this->assertTrue($method->invoke($this->service, $tempDir . DIRECTORY_SEPARATOR . 'nginx/access.log'));
        ...
        $this->assertFalse($method->invoke($this->service, rtrim($tempDir, DIRECTORY_SEPARATOR) . 'o'));
    }
}
