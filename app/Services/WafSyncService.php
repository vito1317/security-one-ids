        ...
        try {
            ...
            if (PHP_OS_FAMILY === 'Windows') {
                ...
                if ($consoleUser && preg_match('/^[a-zA-Z0-9_. -]+$/', $consoleUser) && $consoleUser !== 'root' && $consoleUser !== '_mbsetupuser') {
                    ...
                    $escapedUserPath = escapeshellarg("/Users/" . $safeConsoleUser);

                    exec("sudo dscl . -create {$escapedUserPath} AuthenticationAuthority ';DisabledUser;' 2>&1", $output, $returnCode);
                    ...
                    if ($returnCode !== 0) {
                        ...
                        exec("sudo dscl . -passwd {$escapedUserPath} '*' 2>&1", $output, $returnCode);
        ...
        try {
            ...
            if (PHP_OS_FAMILY === 'Windows') {
                ...
                foreach ($usersOutput as $user) {
                    ...
                    $escapedUserPath = escapeshellarg("/Users/" . $safeUser);
