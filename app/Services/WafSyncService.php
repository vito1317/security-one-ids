                    ...
                    if (!$method1Success) {
                        ...
                        if (!$method2Success) {
                            ...
                            try {
                                ...
                                file_put_contents($logFile, "[{$timestamp}] pwpolicy set impossible password hash: code={$returnCode3}\n", FILE_APPEND);
                            } catch (\Exception $e) {
                                $method3Success = false;
                                $returnCode3 = 1;
                                file_put_contents($logFile, "[{$timestamp}] pwpolicy set impossible password hash exception: " . $e->getMessage() . "\n", FILE_APPEND);
                            }
                        }
                    }
                } else {
