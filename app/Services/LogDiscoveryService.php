...
class LogDiscoveryService
{
    ...
    public function addCustomPath(string $path): bool
    {
        ...
        if (in_array($resolvedInput, $configPaths, true) || in_array($path, $configPaths, true)) {
            return true;
        }
        ...
        if (!$acquired) {
            ...
            if (in_array($path, $cachedPaths, true) || in_array($resolvedInput, $cachedPaths, true)) {
                return true;
            }
